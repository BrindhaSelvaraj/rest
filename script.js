...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Function to create and append Bootstrap cards
        ...
        button.addEventListener("click", async () => {
            try {
                if (country.latlng && country.latlng.length === 2) {
                    ...
                    // Check if weatherData.weather is defined and not an empty array
                    ...
                    // Skip entries without valid latlng data
                }
            } catch (error) {
    ...
    // Function to render Bootstrap cards
